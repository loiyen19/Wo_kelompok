...
$dsn = 'mysql:host=127.0.0.1;dbname=dbwedding';
$user = 'root';
$password = '';
$database = new Nette\Database\Connection($dsn, $user, $password);

$result = $database->query('SELECT ID_produk, Nama_produk, Deskripsi, Harga,
Tgl_masuk,Stok, Diskon,Gambar,Date_created FROM tbl_produk order by rand() limit 0,10');
